<?php
  ...
  $data = '?api_key=wX9NwuHnZU2ToO7GmGR9uw&route='.$busnumber.'&format=json';
  $url = $webapi . $data;
  //  Initiate curl
  $ch = curl_init();
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">MBTA Bus Search</a>
        </div>
    ...
    <table class="table">
      ...
      <tbody>
      <?php
      foreach ($jsonData['direction'][0]['stop'] as $item) {
        echo "<tr>";
        echo "<td>".$item["stop_name"]."</td>";
        echo "<td>".$item["stop_id"]."</td>";
        echo "</tr>";
      }
    ...
    <table class="table">
      ...
      <tbody>
        <?php
      foreach ($jsonData['direction'][1]['stop'] as $item) {
        echo "<tr>";
        echo "<td>".$item["stop_name"]."</td>";
        echo "<td>".$item["stop_id"]."</td>";
        echo "</tr>";
